					...
					<Stack className="main-box">
						<Stack className="left-config">
							<Stack className={'image-info'}>
								<img src={'/img/logo/logoText.png'} />
								<Stack className={'community-name'}>
									<Typography className={'name'}>Choose the category</Typography>
								</Stack>
							</Stack>
							<Tabs
							...
							<div className="config">
								<Stack className="first-box-config">
									...
									<Stack className="like-and-dislike">
										<Stack className="top">
											<Button>
												{boardArticle?.meLiked && boardArticle?.meLiked[0]?.myFavorite ? <ThumbUpAltIcon onClick={() => likeBoArticleHandler(user, boardArticle?._id)} /> : <ThumbUpOffAltIcon onClick={() => likeBoArticleHandler(user, boardArticle?._id)} />}
												<Typography className="text">{boardArticle?.articleLikes}</Typography>
											</Button>
										</Stack>
									</Stack>
